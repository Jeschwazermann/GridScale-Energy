...
const testimonials = [
  ...
  },
  {
    ...
    photo: "/images/testimonial-fatima.jpg",
    initials: "FA",
    ...
    <section id="testimonials" className="py-24 px-6 bg-gray-50" ref={ref}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map(
            ({ quote, name, role, photo, initials, color }, i) => (
              <div
                key={i}
                ...
                <div className="flex items-center gap-3">
                  {photo ? (
                    <img
                      src={photo}
                      alt={name}
                      className="w-10 h-10 rounded-full object-cover shrink-0 ring-2 ring-offset-1 ring-teal-100"
                    />
                  ) : (
                    <div
